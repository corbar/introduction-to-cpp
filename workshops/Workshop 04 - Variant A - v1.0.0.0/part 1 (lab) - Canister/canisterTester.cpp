#include <iostream>
#include "Canister.h"
#include "Canister.h" // intentional
...
int main()
{
	...
	seneca::Canister canCol[] = {
	   seneca::Canister(),                             // default size
	   seneca::Canister(100,  20),                     // bad diameter, default size
	   seneca::Canister(5  ,  20),                     // bad diameter, default size
	   seneca::Canister(20 ,   5),                     // bad height, default size
	   seneca::Canister(20 , 100),                     // bad height, default size
	   seneca::Canister(30 ,  40),                     // OK
	   seneca::Canister(nullptr, 123.456),             // bad name, empty, default size
	   seneca::Canister("Orange Juice", 0),            // bad qty, empty,default size
	   seneca::Canister("Orange Juice", 123.456),      // OK
	   seneca::Canister(9, 20,  "Olive Oil", 321.456), // bad diameter, default size
	   seneca::Canister(20, 9,  "Water", 321.456),     // bad height,   default size
	   seneca::Canister(20, 20, "", 321.456),          // bad name, empty
	   seneca::Canister(20, 20, "Olive Oil", 0),       // bad qty, empty
	   seneca::Canister(20, 20, "Olive Oil", 321.456), // OK
	   seneca::Canister(15, 20, "Milk", 4321.456),     // too much milk
	   seneca::Canister(10, 10, "Gasoline", 456.321),  // OK
	   seneca::Canister("Orange Juice", 578.456),      // OK
	   seneca::Canister("Olive Oil",    578.456),      // OK
	   seneca::Canister(20, 20, "Olive Oil", 321.456), // OK
	   seneca::Canister(20, 20, "Olive Oil", 321.456), // OK
	};
