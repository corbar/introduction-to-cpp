...
int main()
{
...

	{
		...
		std::cout << "| Name       |   Number |    Balance |\n"
			<< "--------------------------------------\n";
		seneca::Account acc("Cornel", 123456, -500.0); // OK account
		acc.display();
...

	{
		...
		std::cout << "| Name       |   Number |    Balance |\n"
			<< "--------------------------------------\n";
		seneca::Account acc1("Cornel", 123456, 500.0);   // OK account
		seneca::Account acc2("Vanessa", 654321, 5000.0); // OK account
		acc1.display(); //  500
		acc2.display(); // 5000
